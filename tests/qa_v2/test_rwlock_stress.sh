#!/bin/bash
# ============================================================================
# QA Test: Multithreaded RwLock Stress (BUG-007b regression guard)
# ============================================================================
# Spawns 10 threads doing 100 open/close each through the inception layer.
# If init() gets accidentally inlined into get() (>512KB stack frame),
# or if IPC calls use interposed libc, threads will deadlock.
#
# See docs/BUG-007-BOOTSTRAP-DEADLOCK.md § BUG-007b for full analysis.
