use crate::interpose::*;
use crate::state::*;
use libc::{c_char, c_int, ssize_t, size_t};
use std::ffi::CStr;

#[no_mangle]
#[cfg(target_os = "macos")]
pub unsafe extern "C" fn readlink_shim(path: *const c_char, buf: *mut c_char, bufsiz: size_t) -> ssize_t {
...
#[no_mangle]
#[cfg(target_os = "macos")]
pub unsafe extern "C" fn realpath_shim(path: *const c_char, resolved_path: *mut c_char) -> *mut c_char {
